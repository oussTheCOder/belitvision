...
export const posts: BlogPost[] = [
  {
    ...
    content: {
      ...
      en: [
        ...
        { type: "html", text: "Step 3: Add Your IPTV Details. Enter the IPTV details provided after your subscription activation. Make sure there are no typing mistakes, especially in the server URL, username, or password. Before choosing a long-term plan, many users prefer to start with an <a href=\"https://wa.me/12338956041?text=Hello%2C%20could%20you%20provide%20me%20with%20belitvision%20trial%20test%3F\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-primary hover:underline\">iptv trial test</a> to check the streaming quality, channel list, app compatibility, and server stability on their Android device." },
